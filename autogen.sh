...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_dgr to login script."
...
# the current dir:
if   test x${GTLANG_dgr} = x ; then
	echo "WARNING: The variable \${GTLANG_dgr} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_dgr} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_dgr} has the value:"
	echo "  ${GTLANG_dgr}"
