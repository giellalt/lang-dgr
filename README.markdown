...
This directory contains source files for the Dogrib language morphology
...
-   <https://giellalt.uit.no/lang/dgr/DogribDocumentation.html>
    (analyser)
...
In order to compile and use Dogrib language morphology and dictionaries,
you need:
...
The Dogrib language sources can be acquired using [giella SVN
